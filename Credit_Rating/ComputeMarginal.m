...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
  Joint_distr = ComputeJointDistribution(ObserveEvidence(F, E));
  Joint_distr.val = Joint_distr.val ./ sum(Joint_distr.val);
  %Marginalization already done. just call it
  M = FactorMarginalization(Joint_distr, setdiff(Joint_distr.var, V));
